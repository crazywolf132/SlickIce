...
class ExpressKey extends \Concrete\Core\Entity\Attribute\Key\ExpressKey implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entity', 'akID', 'akHandle', 'akName', 'akIsSearchable', 'akIsInternal', 'akIsSearchableIndexed', 'key_type', 'set_keys', 'attribute_values', 'category', 'package'];
        }
