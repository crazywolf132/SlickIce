 ...
 */
class AddressType extends \Concrete\Core\Entity\Attribute\Key\Type\AddressType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akDefaultCountry', 'akHasCustomCountries', 'customCountries', 'akTypeID', 'akTypeHandle', 'key'];
        }
