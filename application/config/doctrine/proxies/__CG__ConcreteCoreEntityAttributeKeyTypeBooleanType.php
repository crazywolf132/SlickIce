 ...
 */
class BooleanType extends \Concrete\Core\Entity\Attribute\Key\Type\BooleanType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akCheckedByDefault', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BooleanType $proxy) {
