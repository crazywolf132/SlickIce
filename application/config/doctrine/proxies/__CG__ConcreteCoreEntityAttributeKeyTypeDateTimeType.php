 ...
 */
class DateTimeType extends \Concrete\Core\Entity\Attribute\Key\Type\DateTimeType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akDateDisplayMode', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DateTimeType $proxy) {
