 ...
 */
class ExpressType extends \Concrete\Core\Entity\Attribute\Key\Type\ExpressType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'entity', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExpressType $proxy) {
