 ...
 */
class ImageFileType extends \Concrete\Core\Entity\Attribute\Key\Type\ImageFileType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akFileManagerMode', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageFileType $proxy) {
