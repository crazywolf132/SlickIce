 ...
 */
class SelectType extends \Concrete\Core\Entity\Attribute\Key\Type\SelectType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'list', 'akSelectAllowMultipleValues', 'akSelectAllowOtherValues', 'akSelectOptionDisplayOrder', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelectType $proxy) {
