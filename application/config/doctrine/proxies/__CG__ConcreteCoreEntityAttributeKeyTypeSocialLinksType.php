 ...
 */
class SocialLinksType extends \Concrete\Core\Entity\Attribute\Key\Type\SocialLinksType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialLinksType $proxy) {
