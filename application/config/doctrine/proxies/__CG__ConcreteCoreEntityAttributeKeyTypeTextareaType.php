 ...
 */
class TextareaType extends \Concrete\Core\Entity\Attribute\Key\Type\TextareaType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akTextareaDisplayMode', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextareaType $proxy) {
