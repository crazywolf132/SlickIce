 ...
 */
class TopicsType extends \Concrete\Core\Entity\Attribute\Key\Type\TopicsType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akTopicParentNodeID', 'akTopicTreeID', 'akTypeID', 'akTypeHandle', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TopicsType $proxy) {
