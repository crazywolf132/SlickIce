...
class UserKey extends \Concrete\Core\Entity\Attribute\Key\UserKey implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'uakProfileDisplay', 'uakProfileEdit', 'uakProfileEditRequired', 'uakRegisterEdit', 'uakRegisterEditRequired', 'uakMemberListDisplay', 'akID', 'akHandle', 'akName', 'akIsSearchable', 'akIsInternal', 'akIsSearchableIndexed', 'key_type', 'set_keys', 'attribute_values', 'category', 'package'];
        }
