 ...
 */
class LegacyValue extends \Concrete\Core\Entity\Attribute\Value\LegacyValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'avrID', 'attribute_key', 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LegacyValue $proxy) {
