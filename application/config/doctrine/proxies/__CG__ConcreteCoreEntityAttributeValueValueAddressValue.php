...
class AddressValue extends \Concrete\Core\Entity\Attribute\Value\Value\AddressValue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'address1', 'address2', 'address3', 'city', 'state_province', 'country', 'postal_code', 'avID', 'attribute_values'];
        }

        return ['__isInitialized__', 'avID', 'attribute_values'];
    }
