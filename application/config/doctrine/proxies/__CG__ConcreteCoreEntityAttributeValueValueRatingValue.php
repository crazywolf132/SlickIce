 ...
 */
class RatingValue extends \Concrete\Core\Entity\Attribute\Value\Value\RatingValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RatingValue $proxy) {
