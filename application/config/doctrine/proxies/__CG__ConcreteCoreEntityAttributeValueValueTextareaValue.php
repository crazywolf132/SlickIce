 ...
 */
class TextareaValue extends \Concrete\Core\Entity\Attribute\Value\Value\TextareaValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'avID', 'attribute_values'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextareaValue $proxy) {
