...
class Version extends \Concrete\Core\Entity\File\Version implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'file', 'fvID', 'fvFilename', 'fvPrefix', 'fvDateAdded', 'fvActivateDateTime', 'fvIsApproved', 'fvAuthorUID', 'fvSize', 'fvApproverUID', 'fvTitle', 'fvDescription', 'fvExtension', 'attributes', 'fvType', 'fvTags', 'fvHasListingThumbnail', 'fvHasDetailThumbnail'];
        }
     ...
     * {@inheritDoc}
     */
    public function setFileVersionAttribute($ak, $value)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFileVersionAttribute', [$ak, $value]);

        return parent::setFileVersionAttribute($ak, $value);
    }
