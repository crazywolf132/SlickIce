...
class Install extends Controller
{
        ...
        if (file_exists(DIR_CONFIG_SITE . '/site_install_user.php')) {
            ...
            if ($e->has()) {
                ...
                $this->set(
                    'successMessage',
                    t(
                        'Congratulations. SlickIce has been installed. You have been logged in as <b>%s</b> with the password you chose. If you wish to change this password, you may do so from the users area of the dashboard.',
                        USER_SUPER
                    )
                );
            }
    ...
    public function on_start()
    {
        ...
        $this->set('pageTitle', t('Install SlickIce'));
    }
